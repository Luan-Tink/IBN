...
class SermonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sermon" do
    assert_difference('Sermon.count') do
      post sermons_url, params: { sermon: { date: @sermon.date, preacher: @sermon.preacher, series: @sermon.series, text: @sermon.text, title: @sermon.title, video: @sermon.video } }
    end
  ...
  test "should update sermon" do
    patch sermon_url(@sermon), params: { sermon: { date: @sermon.date, preacher: @sermon.preacher, series: @sermon.series, text: @sermon.text, title: @sermon.title, video: @sermon.video } }
