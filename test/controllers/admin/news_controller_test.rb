...
class Admin::NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_news" do
    assert_difference('Admin::News.count') do
      post admin_news_index_url, params: { admin_news: { cover: @admin_news.cover, date: @admin_news.date, description: @admin_news.description, kind: @admin_news.kind, thumb: @admin_news.thumb, title: @admin_news.title } }
    end
  ...
  test "should update admin_news" do
    patch admin_news_url(@admin_news), params: { admin_news: { cover: @admin_news.cover, date: @admin_news.date, description: @admin_news.description, kind: @admin_news.kind, thumb: @admin_news.thumb, title: @admin_news.title } }
