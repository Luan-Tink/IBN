...
class Admin::EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post admin_events_url, params: { admin_event: { cover: @admin_event.cover, date: @admin_event.date, description: @admin_event.description, thumb: @admin_event.thumb, title: @admin_event.title } }
    end
  ...
  test "should update admin_event" do
    patch admin_event_url(@admin_event), params: { admin_event: { cover: @admin_event.cover, date: @admin_event.date, description: @admin_event.description, thumb: @admin_event.thumb, title: @admin_event.title } }
